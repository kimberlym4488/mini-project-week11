...
* It's done when I have created a custom `404.html` page for my wildcard route to serve. DONE
...
* It's done when I have tested the wildcard route by visiting any non-existent path, like `http://localhost/test`. Done
